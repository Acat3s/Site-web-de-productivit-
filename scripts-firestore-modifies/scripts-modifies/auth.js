...
function addGuestBanner() {
  ...
  const loginFromBanner = document.getElementById('login-from-banner');
  if (loginFromBanner) {
    loginFromBanner.addEventListener('click', (e) => {
      e.preventDefault();
      openAuthModal('login');
    });
  }
...
export { authState, openAuthModal, closeAuthModal, logout };
